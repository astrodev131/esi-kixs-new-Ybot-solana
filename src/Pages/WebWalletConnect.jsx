...
const WebWalletConnect = () => {
    ...
    return (
        <div className="h-dvh flex flex-col justify-center items-center gap-y-8 text-center mx-4">
            ...
            {wallet.connected && (
                <Link
                    className="text-lg font-bold rounded-md bg-[#1D1C17] px-4 py-3 text-black"
                    to={"https://t.me/DogeKombatGame_bot"}
                >
                    Back to Game
                </Link>
            )}
